...
/**
* @brief save input array to a text file
*/
static void save_input_to_txt(const T* A, unsigned int nr_elements, const char *output_file) {
...
int main(int argc, char **argv) {
    ...
    read_input(A, p);
    save_input_to_txt(A, input_size, "HST.txt");
