...
class PIMDRAMSystem final : public IMemorySystem, public Implementation {
  ...
  public:
    ...
    int s_num_pim_write_to_bank_requests = 0;
  ...
  public:
    void init() override { 
      ...
      register_stat(s_num_pim_write_to_bank_requests).name("total_num_pim_write_to_bank_requests");
    ...
    bool send(Request req) override {
      ...
      if (is_success) {
        switch (req.type_id) {
          ...
          case Request::Type::PIM_WR_BK: {
            s_num_pim_write_to_bank_requests++;
            break;
          }
